...
Pod::Spec.new do |s|
  ...
  s.name         = "reyunsdk"
  s.version      = "1.5.5"
  s.summary      = "the sdk library of the reyun login sdk pod spec."
  ...
  s.description  = <<-DESC
        the sdk library of the reyun analysis sdk pod spec
                   DESC
  ...
  s.source       = { :git => "ssh://git@fantang.f3322.net:58178/liyajie/podrepo.git"}
  ...
  s.frameworks = "Foundation" , "Security" , "AdSupport","SystemConfiguration", "CoreMotion" , "CFNetwork" , "WebKit" ,"iAd" , "AVFoundation", "CoreTelephony"
